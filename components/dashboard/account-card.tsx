...
export function AccountCard({
  account,
  cardLast4,
  showCreditShortcuts = false,
}: {
  account: BankAccount & { creditLimitCents?: number }
  cardLast4?: string
  /** Multi-product members only: Order physical card + View activities */
  showCreditShortcuts?: boolean
}) {
          ...
          <div className="space-y-3">
            ...
            {showCreditShortcuts && (
              <div className="flex flex-wrap gap-2 pt-1">
                ...
                <Link
                  href={`/dashboard/credit-activity?accountId=${account.id}`}
